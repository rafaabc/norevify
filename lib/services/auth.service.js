...
async function register({ username, password, email, currency, consent, ip }) {
...
async function verifyEmail({ token }) {
  if (!token) throw makeError(400, 'token is required');
...
module.exports = { register, login, changePassword, forgotPassword, resetPassword, updateCurrency, updateLanguage, updateOdometer, googleLogin, linkGoogle, unlinkGoogle, getProviders, verifyEmail, resendVerification, exportUserData, deleteAccount };
