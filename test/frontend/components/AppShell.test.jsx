...
vi.mock('@/components/Sidebar.jsx', () => ({
  default: ({ badgeCount }) => <div data-testid="sidebar" data-badge={badgeCount} />,
}));
vi.mock('@/components/MobileTopBar.jsx', () => ({
  default: ({ badgeCount }) => <div data-testid="mobile-top-bar" data-badge={badgeCount} />,
}));
vi.mock('@/components/BottomTabs.jsx', () => ({
  default: () => <div data-testid="bottom-tabs" />,
}));
...
describe('AppShell', () => {
  ...
  it('should hide resend button after successful resend', async () => {
    ...
    expect(
      screen.queryByRole('button', { name: 'auth.verifyEmail.bannerAction' }),
